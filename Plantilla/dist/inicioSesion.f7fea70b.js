...
})({"eVcFU":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "9ab80e42f7fea70b";
"use strict";
...
},{}],"dwxGx":[function(require,module,exports) {
...
inicio.addEventListener("click", async function() {
    let datos = await (0, _getUsers.getUsers)();
    for(let index = 0; index < datos.length; index++){
        ...
        if (resultadoGmail === "" || resultadopassword === "") texto.innerHTML = "NO SE HAN ENCONTRADO DATOS EN DONDE SE SOLICITA, POR FAVOR LLENAR CORRECTAMENTE LOS DATOS SOLICITADOS";
        else {
            ...
            if ((datos[index].usuario === userOrGmail.value || datos[index].correo === userOrGmail.value) && datos[index].pass === password.value) {
                texto.innerHTML = "TUS DATOS SE ENCUENTRAN REGRISTRADO... HAS ENTRADO CON EX\xcdTO";
                localStorage.setItem("codigo", datos[index].codigo);
                setTimeout(()=>{
                    window.location.href = "./formulario.html";
                }, 3500);
                break;
            } else texto.innerHTML = "SE HAN INGRESADOS DATOS INCORRECTOS O INEXISTENTES POR FAVOR REVISAR DATOS O REGISTRASE NUEVAMENTE";
        }
    }
});
...
},{}]},["eVcFU","dwxGx"], "dwxGx", "parcelRequire6682")

//# sourceMappingURL=inicioSesion.f7fea70b.js.map
