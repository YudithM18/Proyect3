...
//Llamados
var _getSolicitudes = require("../services/getSolicitudes");
var _postSolicitudes = require("../services/postSolicitudes");
var _updateSolicitudes = require("../services/updateSolicitudes");
var _deleteSolicitudes = require("../services/deleteSolicitudes");
//Declaración de HTML
...
btnS.addEventListener("click", function() {
    ...
    async function cargarSolicitudes() {
        const solicitud = await (0, _getSolicitudes.getSolicitudes)();
        renderSolicitud(solicitud);
    }
    async function enviarS() {
        if (!nombreF.value || !codigoF.value || !sede.value || !salidaF.value || !regresoF.value) anuncio.innerHTML = "Completar la informaci\xf3n";
        await (0, _postSolicitudes.postSolicitudes)(solicitudObj);
...
},{"../services/getSolicitudes":"4kywO","../services/postSolicitudes":"6EeXe","../services/updateSolicitudes":"bmijd","../services/deleteSolicitudes":"dkuVS"}],"4kywO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getSolicitudes", ()=>getSolicitudes);
...
},{}],"6EeXe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "postSolicitudes", ()=>postSolicitudes);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bmijd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "updateSolicitudes", ()=>updateSolicitudes);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dkuVS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "deleteSolicitudes", ()=>deleteSolicitudes);
async function deleteSolicitudes(id) {
    try {
        ...
        if (!response.ok) throw new Error(`Error deleting solicitud with id ${id}`);
        return {
            message: `Solicitud with id ${id} deleted successfully`
        };
    } catch (error) {
