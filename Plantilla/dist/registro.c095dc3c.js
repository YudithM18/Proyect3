...
btnCrear.addEventListener("click", function() {
    ...
    async function validar() {
        const infoUsers = await (0, _getUsers.getUsers)();
        ...
        if (correoExistente.length > 0) {
            ...
            } else if (correo.value.length > 0 && usuario.value.length > 0 && pass.value.length > 0 && codigo.value.length > 0) {
                texto.innerHTML = "USTED HA SIDO REGISTRADO CON EX\xcdTO";
                (0, _postUsers.postUsers)(usuario.value, correo.value, pass.value, codigo.value);
                setTimeout(()=>{
